...
const ShareButtons = () => {
  ...
  return (
    <Styles.Socials id="socials">
      <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" className="twitter-share-button" data-show-count="false" target="_blank"><Styles.Button theme={theme}>Tweet Product</Styles.Button></a><script async src="https://platform.twitter.com/widgets.js" charSet="utf-8"></script>
      ...
      <a className="w-inline-block social-share-btn pin" href="http://pinterest.com/pin/create/button/?url=&description=" target="_blank" title="Pin it" onClick={() => {
        ...
        <Styles.Button theme={theme}>Pin Product</Styles.Button>
      </a>
      ...
      <a className="w-inline-block social-share-btn fb" href={url} title="Share on Facebook" target="_blank" onClick={() => {
        ...
        <Styles.Button theme={theme}>The Facebook</Styles.Button>
      </a>
    </Styles.Socials>
  );
};
